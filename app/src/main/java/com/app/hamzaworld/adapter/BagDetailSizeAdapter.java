...
public class BagDetailSizeAdapter extends RecyclerView.Adapter<BagDetailSizeAdapter.ViewHolder> {
    ...
    public BagDetailSizeAdapter(Context context, ArrayList<AllSize> sizeList) {
