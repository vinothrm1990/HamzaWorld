...
import static com.app.hamzaworld.activity.BagDetailActivity.btnCart;
import static com.app.hamzaworld.activity.BagDetailActivity.btnSave;

public class BagDetailColorAdapter extends RecyclerView.Adapter<BagDetailColorAdapter.ViewHolder> {
    ...
    public BagDetailColorAdapter(Context context, ArrayList<AllColor> colorList) {
