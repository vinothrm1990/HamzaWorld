...
public class GrabOfferActivity extends AppCompatActivity implements InternetConnectivityListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grab_offer);
        ...
        detailLayout = findViewById(R.id.goffer_layout);
        emptyLayout = findViewById(R.id.goffer_empty_layout);
        tvName = findViewById(R.id.goffer_tv_name);
        tvPrice = findViewById(R.id.goffer_price);
        tvCrossPrice = findViewById(R.id.goffer_cprice);
        tvRate = findViewById(R.id.goffer_prate);
        tvStock = findViewById(R.id.goffer_stock);
        tvTabProduct = findViewById(R.id.goffer_tab_product);
        tvTabDetail = findViewById(R.id.goffer_tab_detail);
        tvTabReview = findViewById(R.id.goffer_tab_review);
        tvProductColor = findViewById(R.id.tab_goffer_color);
        tvProductSize = findViewById(R.id.tab_goffer_size);
        tvDetailCategory = findViewById(R.id.tab_goffer_category);
        tvDetailBrand = findViewById(R.id.tab_goffer_brand);
        tvDetailDesc = findViewById(R.id.tab_goffer_desc);
        ...
        btnLayout = findViewById(R.id.goffer_btn_layout);
        btnSave = findViewById(R.id.goffer_btn_save);
        btnCart = findViewById(R.id.goffer_btn_cart);
        ...
        rvReview = findViewById(R.id.rv_goffer_review);
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Prefs.getBoolean("notLoggedIn", true)){
                    FBToast.infoToast(GrabOfferActivity.this, "Login or Register to Proceed", FBToast.LENGTH_SHORT);
                }else {
                    Date now = new Date();
                    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
                    String timestamp = sdf.format(now);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, GET_BAG_FLAG_URL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(GrabOfferActivity.this);
                        ...
                        try {
                            ...
                            if (jsonObject != null){
                                ...
                                if (jsonObject.getString("status")
                                    ...
                                    FBToast.successToast(GrabOfferActivity.this, jsonObject.getString("message"), FBToast.LENGTH_SHORT);

                                }else if (jsonObject.getString("status")
                                        .equalsIgnoreCase("Already")){
                                    progress.setVisibility(View.GONE);
                                    getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                                    FBToast.infoToast(GrabOfferActivity.this, jsonObject.getString("message"), FBToast.LENGTH_SHORT);
                                }
                                else if (jsonObject.getString("status")
                        ...
                        try {
                            ...
                            if (jsonObject != null){
                                ...
                                if (jsonObject.getString("status")
                                    ...
                                    reviewAdapter = new ReviewAdapter(GrabOfferActivity.this, reviewList);
                            ...
                            if (jsonObject != null){
                                ...
                                if (jsonObject.getString("status")
                                    ...
                                    if (sliderimage!=null && !sliderimage.isEmpty()){
                                        ...
                                        detailAdapter= new DetailAdapter(GrabOfferActivity.this,imgList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            startActivity(new Intent(GrabOfferActivity.this, CartActivity.class));
            Bungee.swipeRight(GrabOfferActivity.this);
            return true;
        }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(GrabOfferActivity.this, HomeActivity.class));
        Bungee.swipeLeft(GrabOfferActivity.this);
    }
