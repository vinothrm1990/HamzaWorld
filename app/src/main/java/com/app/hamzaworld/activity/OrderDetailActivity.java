...
public class OrderDetailActivity extends AppCompatActivity implements InternetConnectivityListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailLayout = findViewById(R.id.order_detail_layout);
        emptyLayout = findViewById(R.id.order_detail_empty_layout);
        tvName = findViewById(R.id.order_detail_tv_name);
        tvPrice = findViewById(R.id.order_detail_price);
        tvCrossPrice = findViewById(R.id.order_detail_cprice);
        tvRate = findViewById(R.id.order_detail_prate);
        tvStock = findViewById(R.id.order_detail_stock);
        tvTabProduct = findViewById(R.id.order_detail_tab_product);
        tvTabDetail = findViewById(R.id.order_detail_tab_detail);
        tvTabReview = findViewById(R.id.order_detail_tab_review);
        ...
        btnLayout = findViewById(R.id.order_detail_btn_layout);
        btnSave = findViewById(R.id.order_detail_btn_save);
        btnCart = findViewById(R.id.order_detail_btn_cart);
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Prefs.getBoolean("notLoggedIn", true)){
                    FBToast.infoToast(OrderDetailActivity.this, "Login or Register to Proceed", FBToast.LENGTH_SHORT);
                }else {
                    Date now = new Date();
                    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
                    String timestamp = sdf.format(now);
                        ...
                        try {
                            ...
                            if (jsonObject != null){
                                ...
                                if (jsonObject.getString("status")
                                    ...
                                    progress.setVisibility(View.GONE);
                                    getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                                    FBToast.infoToast(OrderDetailActivity.this, jsonObject.getString("message"), FBToast.LENGTH_SHORT);
                                }
                                else if (jsonObject.getString("status")
                        ...
                        try {
                            ...
                            if (jsonObject != null){
                                ...
                                if (jsonObject.getString("status")
                                    ...
                                    reviewAdapter = new ReviewAdapter(OrderDetailActivity.this, reviewList);
                            ...
                            if (jsonObject != null){
                                ...
                                if (jsonObject.getString("status")
                                    ...
                                    if (sliderimage!=null && !sliderimage.isEmpty()){
                                        ...
                                        detailAdapter= new DetailAdapter(OrderDetailActivity.this,imgList);
                                    ...
                                    if (color!=null && !color.isEmpty() && color.trim().length() > 0){
                                        ...
                                        for (int i = 0; i < allColor.size(); i++) {
                                            rbColor = new RadioButton(OrderDetailActivity.this);
                                    ...
                                    rgColor.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                                        ...
                                        public void onCheckedChanged(RadioGroup group, int checkedId) {
                                            ...
                                            FBToast.infoToast(OrderDetailActivity.this, String.valueOf(rbColor.getText()), FBToast.LENGTH_SHORT);
                                        }
                                    });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            ...
            Bungee.swipeRight(OrderDetailActivity.this);
            return true;
        }
    ...
    public void onBackPressed() {
        ...
        Bungee.swipeLeft(OrderDetailActivity.this);
    }
